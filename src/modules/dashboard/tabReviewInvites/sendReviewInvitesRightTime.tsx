        ...
        <div className="ts-w-[calc(100%-112px)]">
          ...
          <div className="ts-flex">
            <p className="ts-text-default ts-text-sm ts-mb-4">
              {phrasesByKey.application_invites_send_export_reviews_description}
            </p>
          ...
          <div className="ts-flex ts-flex-col ts-gap-2 ts-mt-8">
            ...
            <div className="ts-flex ts-items-center ts-justify-center ts-mb-8">
              ...
              <div className="ts-w-[calc(100%-112px)] ts-ml-6">
                <TextWithLink
                  id={'Upgrade now'}
                  url={phrasesByKey.application_invites_send_export_reviews_url_1}
                  text={phrasesByKey.application_invites_send_export_reviews_title}
            ...
            <div className="">
              <p className="ts-text-default ts-text-sm ts-mb-8">
                {phrasesByKey.application_invites_send_export_reviews_footerDescription}
              </p>
              <TextWithLink
                id={'Control Centre'}
                url={phrasesByKey.application_invites_send_export_reviews_url_1}
                text={phrasesByKey.application_invites_send_export_reviews_footerText}
